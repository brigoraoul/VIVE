...
from Value_Extraction_Agent.db_utils.models.value import Value
...
class DAO:
    ...
    def __init__(self):
        ...
        self.database_path = ""  # insert local database path
    ...
    def get_value_representations(self):
        """
        Getting full value representations for all values.
        Returns: Dictionary of class "Value" objects
        """
    ...
    def get_messages(self):
        """
        Get all messages from the data set that was used in the value identification.
